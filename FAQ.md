...
If that's the case, you are using deprecated libraries/commands. This happens
...
It looks like the Domain type property in the Google Search Console to verify
